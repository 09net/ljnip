<template>
 ...
 <view class="list-view">
    ...
    <block v-for="(newsitem,index2) in data"  :key="index2">
                        <media-list :newsitem="newsitem" @close="follow(newsitem)" @click="goDetail(newsitem)"></media-list>
                    </block>
				...
				<uni-drawer :visible="rightDrawerVisible" mode="right" @close="closeRightDrawer">
					<view style="padding:30upx;">
						...
						<view class="uni-list uni-common-mt">
							...
							<view class="uni-list-cell uni-list-cell-last" hover-class="uni-list-cell-hover">
								<view class="uni-list-cell-navigate uni-navigate-right" @tap="gonav2('s')">
搜索
								</view>
							</view>
							<view class="uni-list-cell uni-list-cell-last" hover-class="uni-list-cell-hover">
								<view class="uni-list-cell-navigate uni-navigate-right" @tap="share()">
									分享
								</view>
							</view>
						</view>
...
<script>
    ...
    export default {
        ...
        data() {
            return {
				...
				loadingText: {
					...
					contentnomore: ysv8set.langfun("加载完毕")
				},
				ajaxi:true,
				loadingType:0,
                scrollLeft: 0,
        ...
        methods: {
			...
			setNaivgationBarTitle: function (title) {uni.setNavigationBarTitle({title: title});},
            ...
            goDetail(e) {
                uni.navigateTo({
                    url: '/pages/'+this.mode+'/s?fid=' + e.id
                })
            },
            follow(newsitem) {/*关注*/	
			var addstate=mask.add_array(newsitem,ysv8set.userdata['forum'],true);
